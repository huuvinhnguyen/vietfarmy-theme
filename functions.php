...
function vietfarmy_header_zone_inline() {
    ...
    .vnheader-logo-img img {
        height: 50px; width: auto; display: block;
    }
    .vnheader-logo-text {
        font-size: 20px; font-weight: 700; color: #1a1a1a; text-decoration: none;
    }
    /* Navigation */
    .vnheader-nav {
    ...
    .vnheader-nav a {
        padding: 8px 14px; color: #333; text-decoration: none; font-size: 14px;
    ...
    .vnheader-actions a {
        padding: 8px 16px; background: #2271b1; color: #fff;
        border-radius: 6px; text-decoration: none; font-size: 13px;
        transition: background .2s;
    }
    .vnheader-actions a:hover { background: #135e96; }
    /* Banner */
    .vnheader-banner { display: block; }
    ...
    @media (max-width: 768px) {
        ...
        .vnheader-nav { order: 3; width: 100%; justify-content: center; flex-wrap: wrap; }
    ...
    <div class="vnheader">
        <div class="vnheader-logo-bar">
            ...
            <div class="vnheader-logo">
                <?php if ($logo_url) : ?>
                    <a href="<?php echo esc_url($logo_link); ?>" class="vnheader-logo-img">
                        <img src="<?php echo esc_url($logo_url); ?>" alt="<?php echo esc_attr($site_name); ?>">
                    </a>
                <?php else : ?>
                    <a href="<?php echo esc_url($logo_link); ?>" class="vnheader-logo-text">
                        <?php echo esc_html($site_name); ?>
                    </a>
                <?php endif; ?>
            </div>

            <!-- Menu (shortcode hoặc nav menu) -->
            <nav class="vnheader-nav" aria-label="Header navigation">
                <?php
                if ($menu_shortcode) {
                    ...
                    wp_nav_menu(array(
                        ...
                        'fallback_cb' => function() {
                            ...
                            echo '<a href="' . home_url('/gio-hang') . '">Giỏ hàng</a>';
                        },
                    ));
                }
                ?>
...
// ============================================================
// CUSTOMIZER — Cài đặt Header Zone trong Giao diện > Tùy biến
// ============================================================
add_action('customize_register', 'vietfarmy_header_customize');

function vietfarmy_header_customize($wp_customize) {

    $wp_customize->add_section('vietfarmy_header', array(
