...
class PixelgradeCare_Install_Notice {
	...
	public function outputMarkup() {
		$button_text = __( 'Install the Pixelgrade Care&reg; plugin', 'gema' );
		...
		if ( ! class_exists( 'PixelgradeCare' ) && file_exists( WP_PLUGIN_DIR . '/pixelgrade-care/pixelgrade-care.php' ) ) {
			$button_text = __( 'Activate the Pixelgrade Care&reg; plugin', 'gema' );
		} elseif ( class_exists( 'PixelgradeCare' ) ) {
			// The plugin is actually active.
			$button_text = __( 'Start the Pixelgrade Care&reg; setup', 'gema' );
		}
		...
		<div class="pixcare-notice__container notice is-dismissible" >
			...
			<ul class="pxg-wizard">
				<li class="pxg-wizard__step pxg-wizard__step--done">
					<span class="pxg-wizard__label"><?php esc_html_e( 'Theme', 'gema' ); ?></span>
					<span class="pxg-wizard__progress"><b></b></span>
				</li>
				<li class="pxg-wizard__step pxg-wizard__step--current">
					<span class="pxg-wizard__label"><?php esc_html_e( 'Pixelgrade Care&reg;', 'gema' ); ?></span>
					<span class="pxg-wizard__progress"><b></b></span>
				</li>
				<li class="pxg-wizard__step">
					<span class="pxg-wizard__label"><?php esc_html_e( 'Site setup', 'gema' ); ?></span>
					<span class="pxg-wizard__progress"><b></b></span>
				</li>
				<li class="pxg-wizard__step">
					<span class="pxg-wizard__label"><?php esc_html_e( 'Ready!', 'gema' ); ?></span>
					<span class="pxg-wizard__progress"><b></b></span>
				</li>
			</ul>
				...
				<div class="pixcare-notice__wrap">
					...
					<div class="pixcare-notice__body">
						<h1><?php
							...
							echo wp_kses( sprintf( __( 'Thanks for installing %s, you\'re awesome!<br>Let\'s make an experience out of it.', 'gema' ),  $theme->get( 'Name' ) ), wp_kses_allowed_html('post') ); ?></h1>
						<p><?php echo wp_kses( __('We\'ve prepared a special onboarding setup that helps you get started and configure your upcoming website in style. Let\'s make it shine!', 'gema' ), wp_kses_allowed_html('post') ); ?></p>
						<ul>
							<li>
								<i></i><span><?php echo wp_kses( __('<strong>Recommended plugins</strong> to boost your site.', 'gema' ), wp_kses_allowed_html() ); ?></span>
							</li>
							<li>
								<i></i><span><?php echo wp_kses( __('<strong>Starter Content</strong> to make your site look like the demo.', 'gema' ), wp_kses_allowed_html() ); ?></span>
							</li>
							<li>
								<i></i><span><?php echo wp_kses( __('<strong>Premium Support</strong> to assist you all the way.', 'gema' ), wp_kses_allowed_html() ); ?></span>
							</li>
						</ul>
						...
						<noscript>
							<button type="submit" class="notice-dismiss"><span class="screen-reader-text"><?php esc_html_e( 'Dismiss this notice.', 'gema' ); ?></span></button>
						</noscript>
					</div>
				</div>
	...
	public function outputJS() {
		...
		wp_localize_script( 'pixcare_notice_js', 'pixcareNotice', array(
			...
			'i18n' => array(
				'btnInstall' => esc_html__( 'Install the Pixelgrade Care&reg; plugin', 'gema' ),
				'btnInstalling' => esc_html__( 'Installing Pixelgrade Care&reg;...', 'gema' ),
				'btnActivate' => esc_html__( 'Activate the Pixelgrade Care&reg; plugin', 'gema' ),
				'btnActivating' => esc_html__( 'Activating Pixelgrade Care&reg;...', 'gema' ),
				'btnOpenSetup' => esc_html__( 'Start the Pixelgrade Care&reg; setup', 'gema' ),
				'btnOpeningSetup' => esc_html__( 'Opening the Pixelgrade Care&reg; setup...', 'gema' ),
				'btnRedirectingToSetup' => esc_html__( 'Opening the Pixelgrade Care&reg; setup...', 'gema' ),
				'btnError' => esc_html__( 'Please refresh the page 🙏 and try again...', 'gema' ),
				'installedSuccessfully' => esc_html__( 'Plugin installed successfully.', 'gema' ),
				'activatedSuccessfully' => esc_html__( 'Plugin activated successfully.', 'gema' ),
				'redirectingToSetup' => esc_html__( 'Opening the Pixelgrade Care&reg; setup in a couple of seconds.', 'gema' ),
				'folderAlreadyExists' => esc_html__( 'Plugin destination folder already exists.', 'gema' ),
				'error' => esc_html__( 'We are truly sorry 😢 Something went wrong and we couldn\'t make sense of it and continue with the plugin setup.', 'gema' ),
			),
		) );
	}
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Cheatin&#8217; huh?', 'gema' ) ), null );
	} // End __clone().
