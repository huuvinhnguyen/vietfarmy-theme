    ...
    <div class="card__mask">
        <div class="card__hover">
            ...
            <?php if ( has_post_thumbnail() ) : ?>
                ...
                <div class="card__wrap">
                    <div class="card__shadow">
                        <a href="<?php echo gema_get_post_format_link_url(); ?>" <?php gema_the_post_thumbnail_class( 'card__image' ); ?>>
                            <?php
                    ...
                    <div class="card-title-wrap">
                        <a href="<?php echo gema_get_post_format_link_url(); ?>" class="card__title">
            ...
            <?php else: ?>
                ...
                <div class="card__shadow">
                    <a href="<?php echo gema_get_post_format_link_url(); ?>" class="card__wrap" rel="bookmark">
                        <h2><?php the_title(); get_template_part( 'template-parts/svg/link-svg' ); ?></h2>
                    </a>
                </div>
