...
<div id="comments" class="comments-area">
	...
	comment_form( array(
		'comment_field' => '<p class="comment-form-comment"><label for="comment">' . esc_html_x( 'Comment', 'noun', 'gema' ) . '</label><textarea placeholder="' . esc_attr__( 'Comment', 'gema' ) . '" id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>',
